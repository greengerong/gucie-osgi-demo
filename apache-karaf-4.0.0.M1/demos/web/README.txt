...
[uninstalled] [4.0.0.M1 ] wrapper           standard-4.0.0.M1      Provide OS integration
[uninstalled] [4.0.0.M1 ] obr               standard-4.0.0.M1      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.0.M1 ] config            standard-4.0.0.M1      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.0.M1 ] region            standard-4.0.0.M1      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.0.M1      Provide Jetty engine support
[uninstalled] [4.0.0.M1 ] http              standard-4.0.0.M1      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.0.M1 ] http-whiteboard   standard-4.0.0.M1      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.0.M1 ] war               standard-4.0.0.M1      Turn Karaf as a full WebContainer
[uninstalled] [4.0.0.M1 ] deployers         standard-4.0.0.M1      Provide Karaf deployer
[uninstalled] [4.0.0.M1 ] kar               standard-4.0.0.M1      Provide KAR (KARaf archive) support
[uninstalled] [4.0.0.M1 ] webconsole-base   standard-4.0.0.M1      Base support of the Karaf WebConsole
[uninstalled] [4.0.0.M1 ] webconsole        standard-4.0.0.M1      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.0.M1 ] ssh               standard-4.0.0.M1      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.0.M1.war, and
