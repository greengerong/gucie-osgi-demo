...
console: 
  > bundle:install -s mvn:org.apache.karaf.demos/org.apache.karaf.demos.command/4.0.0.M1
...
http://karaf.apache.org/manual/4.0.0.M1/developers-guide/extending-console.html
